      ...
      <div class="row g-0">
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="{{ asset('img/caneca1.png') }}" class="gallery-lightbox">
              <img src="{{ asset('img/caneca1.png') }}" alt="" class="img-fluid">
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="{{ asset('img/caneca2.png') }}" class="gallery-lightbox">
              <img src="{{ asset('img/caneca2.png') }}" alt="" class="img-fluid">
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="{{ asset('img/camisa2.png') }}" class="gallery-lightbox">
              <img src="{{ asset('img/camisa2.png') }}" alt="" class="img-fluid">
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="{{ asset('img/camisa3.png') }}" class="gallery-lightbox">
              <img src="{{ asset('img/camisa3.png') }}" alt="" class="img-fluid">
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="{{ asset('img/camisa4.png') }}" class="gallery-lightbox">
              <img src="{{ asset('img/camisa4.png') }}" alt="" class="img-fluid">
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="{{ asset('img/agenda2.png') }}" class="gallery-lightbox">
              <img src="{{ asset('img/agenda2.png') }}" alt="" class="img-fluid">
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="{{ asset('img/agenda3.png') }}" class="gallery-lightbox">
              <img src="{{ asset('img/agenda3.png') }}" alt="" class="img-fluid">
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4">
          <div class="gallery-item">
            <a href="{{ asset('img/agenda4.png') }}" class="gallery-lightbox">
              <img src="{{ asset('img/agenda4.png') }}" alt="" class="img-fluid">
            </a>
          </div>
        </div>
